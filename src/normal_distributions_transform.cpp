...
//   pcl::io::savePCDFileASCII ("room_scan2_transformed.pcd", *output_cloud);
  ...
  viewer_final->addPointCloud<pcl::PointXYZ> (input_cloud, input_color, "input_color cloud");
  viewer_final->setPointCloudRenderingProperties (pcl::visualization::PCL_VISUALIZER_POINT_SIZE,1, "input_color cloud");
